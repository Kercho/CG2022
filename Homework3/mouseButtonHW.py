...
def drawPolylines(color='red', thick=3):
    if(count < 2 ): return
...
drawLine(pta, ptb, RED, 1)
drawLine(pta, ptc, RED, 1)
drawLine(ptb, ptc, RED, 1)
...
while not done:
    ...
    pygame.draw.circle(screen, GREEN, pt, 3)
